	...
	<table class="widefat">
		...
		<tbody>
			<tr>
				...
				<td>
					<input id="txtRegistrationNumber" name="txtRegistrationNumber" value="" type="text" size="30">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<select style="width:185px" id="txtMainCategory" name="txtMainCategory">
...
<form name="Technical Data" id="technicalData" method="post" action="<?php echo $_REQUEST['REQUEST_URI']; ?>">
	<table class="widefat">
		...
		<tbody>
			...
			<tr>
				<td>Additions or Changes?</td>
				<td>
					<select name="txtKPPPSelect" id="txtKPPPSelect">
			...
			<tr>
				<td>Additions or Changes?</td>
				<td>
					<select name="txtKPTSelect" id="txtKPTSelect">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
			...
			<tr>
				<td>Additions or Changes?</td>
				<td>
					<select name="txtKPSBSelect" id="txtKPSBSelect">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
...
<form name="Company’s Financial Information" id="companyFinancialInformation" method="post" action="<?php echo $_REQUEST['REQUEST_URI']; ?>">
	<table class="widefat">
		...
		<tbody>
			...
			<tr>
				<td>Additions or Changes in Total Value of immovable assets?</td>
				<td>
					<select name="txtCIASelect" id="txtCIASelect">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
			...
			<tr>
				<td>Additions or Changes in Total Value of Movable assets?</td>
				<td>
					<select name="txtCMASelect" id="txtCMASelect">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
			...
			<tr>
				<td>Contracts Completed in Preceding Year?</td>
				<td>
					<select name="txtCCPYValue" id="txtCCPYValue">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
			...
			<tr>
				<td>Credit Facility in Preceding Year?</td>
				<td>
					<select name="txtCFPYvalue" id="txtCFPYvalue">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
			...
			<tr>
				<td>New Contracts on Hand?</td>
				<td>
					<select name="txtNCHValue" id="txtNCHValue">
						<option value="">Select</option>
						<option value="1">Yes</option>
						<option value="1">No</option>
					</select>
